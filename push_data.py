...
class NetworkSecurityDataExtract:
    def __init__(self):
        try:
            ...
            #logging.error(f"Error occurred while creating MongoDB client: {e}")
...
if __name__=="__main__":
    ...
    networkobj=NetworkSecurityDataExtract()
    records=networkobj.csv_to_json_converter(file_path=FILE_PATH)
    print(f"Total records extracted from CSV file: {len(records)}")
